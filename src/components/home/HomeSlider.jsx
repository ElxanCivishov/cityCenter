          ...
          >
            {sliders?.map((slider) => (
              <SwiperSlide key={slider?.id} className="h-full">
                <div className="flex items-center group mb-6 w-full h-full">
                  <div className="w-full transition-all duration-100 rounded-lg overflow-hidden relative h-full">
                    <img
                      src={slider.image}
                      alt="marka"
                    ...
                    {slider.title && (
                      <div className="flex flex-col gap-1 absolute bottom-8 left-8 md:bottom-20 md:left-20 text-white text-2xl z-10">
