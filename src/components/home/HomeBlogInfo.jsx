      ...
      {isLoading ? (
        ...
        blogInfo && (
          <div className="flex flex-col lg:flex-row gap-10 relative">
            <div className="rounded-lg shadow-lg w-full lg:max-w-max p-3 overflow-hidden bg-white flex flex-col gap-4 px-5 md:px-10 justify-center min-h-[350px] relative group">
              <img
                src={blogInfo?.image}
                alt=""
              ...
              <Link
                ...
                className="text-white transition-all duration-100 mt-8 hover:text-colorPrimary hover:underline flex items-center text-2xl z-10 font-medium"
              >
